...
namespace MarsRoverTests
{
    public class MoveShould
    {
        ...
        {
           var sut = new Move(new Position(0,0) {Direction = Direction.North}, new Grid(3,3));
        ...
        {
            var sut = new Move(new Position(0, 3) {Direction =  Direction.North}, new Grid(3, 3) );
            var actualResult = sut.Forward();
        ...
        public void YCoordinateResetsToMaxYValueWhenFacingSouthAndMovingForward()
        {
            ...
            var sut = new Move(new Position(0,0) {Direction = Direction.South}, new Grid(3,3) );
            var actualResult = sut.Forward();
        ...
        {
            var sut = new Move(new Position(0,0){ Direction = Direction.East}, new Grid(3,3) );
        ...
        {
            var sut = new Move(new Position(3, 0){Direction = Direction.East}, new Grid(3, 3) );
            var actualResult = sut.Forward();
            var expectedResult = new Position(0, 0);
        ...
        {
            var sut = new Move(new Position(2, 1) {Direction = Direction.West}, new Grid(3, 3) );
            var actualResult = sut.Forward();
        ...
        {
            var sut = new Move(new Position(0, 0){Direction = Direction.West}, new Grid(3, 3) );
            var actualResult = sut.Forward();
        ...
        {
            var sut = new Move(new Position(0,1) {Direction = Direction.North}, new Grid(3,3));
        ...
        {
            var sut = new Move(new Position(1,0) {Direction = Direction.East}, new Grid(3,3));
            var actualResult = sut.Backward();
            var expectedResult = new Position(0, 0);
        ...
        {
            var sut = new Move(new Position(1,1) {Direction = Direction.South}, new Grid(3,3));
            var actualResult = sut.Backward();
        ...
        {
            var sut = new Move(new Position(0,3) {Direction = Direction.South}, new Grid(3,3));
            var actualResult = sut.Backward();
            var expectedResult = new Position(0, 0);
        ...
        {
            var sut = new Move(new Position(1,0) {Direction = Direction.West}, new Grid(3,3));
            var actualResult = sut.Backward();
        ...
        {
            var sut = new Move(new Position(3,0) {Direction = Direction.West}, new Grid(3,3));
            var actualResult = sut.Backward();
            var expectedResult = new Position(0, 0);
